	...
	var CONFIG = {
		...
		resolve: {
			alias: {
				...
				// Until this is upgraded to mapbox-gl.js version 50.0, Mapbox's custom layers and thus deck.gl's MapboxLayer, GeoJsonLayer, PolygonLayer etc. etc. cannot be used
